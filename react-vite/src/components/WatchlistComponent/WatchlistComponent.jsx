  ...
  const deleteStock = async (watchlistId, symbol, e) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/watchlists/${watchlistId}/stocks/${symbol}`,
        {
          method: "DELETE",
          credentials: "include",
          headers: {
          ...
          watchlists.map((watchlist) => (
            <li
              className={`list-title ${
                expandedWatchlist === watchlist.id ? "expanded" : ""
              }`}
              key={watchlist.id}
            >
              <div
                className="watchlist-item-header"
                    ...
                    watchlist.stocks.map((stock) => (
                      <li key={stock.symbol} className="stock-item">
                        ...
                        <button
                          ...
                          onClick={(e) =>
                            deleteStock(watchlist.id, stock.symbol, e)
                          }
                        >
                          ×
                        </button>
